...
Feature: Deal Module > Deal Details > Add Activity

  Description: In this feature user is able to add activity under deal details page
...
#------------------------ Case:2 (http://testrails.rapidops.com/index.php?/cases/view/C24567) --------------------------
  ...
  Scenario: As a User, Verify that upon clicking on Save button user can add new Activity
    ...
    And verify 'icon-ic_deal' module and check newly added activity details
...
#------------------------ Case:11 (http://testrails.rapidops.com/index.php?/cases/view/C24577) -------------------------
...
#------------------------ Case:12 (http://testrails.rapidops.com/index.php?/cases/view/C24578) -------------------------
