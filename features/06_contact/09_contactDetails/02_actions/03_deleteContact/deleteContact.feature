...
Feature: Contact Module > Contact Details Widgets > Actions > Delete Contact
...
#------------------------ Case:3 (http://testrails.rapidops.com/index.php?/cases/view/C20981) --------------------------
  ...
  Scenario: Verify, the user is able to delete a contact
    When Verify, the user is able to delete a contact and verify 'Contact deleted successfully' message