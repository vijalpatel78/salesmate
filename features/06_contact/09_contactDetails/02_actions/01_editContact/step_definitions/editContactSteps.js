...
const screenshotPath = './features/06_contact/09_contactDetails/02_actions/01_editContact/screenshots/';
...
When('user is able to update a contact',async function(dataTable) {
    try {
        const contactName = await moduleElementsObj.findContactName(driver, 'Contact 5');
        await contactName.click();
        await driver.sleep(2000);
        const detailPageActions = await formElementsObj.findElementByVisibleText(driver, screenshotPath, 'a', 'Actions ');
        await detailPageActions.click();
        await driver.sleep(1000);
        const editButton = await formElementsObj.findElementByVisibleText(driver, screenshotPath, 'a', ' Edit Contact');
...
When('the user click on the cancel button it should terminate update process',async function(dataTable) {
    try {
        const contactName = await moduleElementsObj.findContactName(driver,'Contact 05');
        await contactName.click();
        await driver.sleep(2000);
        const detailPageActions = await formElementsObj.findElementByVisibleText(driver,screenshotPath,'a','Actions ');
        await detailPageActions.click();
...
When('the user timeline should be updated for that contact after editing contact',async function() {
    try {
        const contactName = await moduleElementsObj.findContactName(driver, 'Contact 05');
        await contactName.click();
...
Then('manage fields link is not visible and log in through {string}',async function(adminUser) {
    try {
        ...
        await closeIcon.click();
        await driver.sleep(1000);
        await openSalesmatePageObj.openSalesmateLoginPage(driver,screenshotPath,'he {string} is on contact listing page');
...
Then('manage fields link is visible and log in through {string}',async function(adminUser) {
    try {
        const contactModule = await moduleElementsObj.findContactModule(driver);
        await contactModule.click();
        await driver.sleep(2000);
...
When('user is not able to update contact without adding value in mandatory fields',async function(dataTable) {
    try {
        const contactName = await moduleElementsObj.clickOnContactName(driver, 1);
        await contactName.click();
        await driver.sleep(2000);
...
Then('check validation as {string}',async function(expectedValidation) {
    try {
        const updateButton = await formElementsObj.findElementById(driver, screenshotPath, 'btnSubmit');
...
When('checking first and last name with more than 255 characters',async function(dataTable) {
    try {
        const contactName = await moduleElementsObj.clickOnContactName(driver, 1);
        await contactName.click();
        await driver.sleep(2000);
...
Then('check validation messages as {string}',async function(expectedLengthValidation) {
    try {
        const updateButton = await formElementsObj.findElementById(driver, screenshotPath, 'btnSubmit');
        await updateButton.click();
        await driver.sleep(2000);
...
When('the user is able to see invalid email Validation while updating a contact',async function(dataTable) {
    try {
        const contactName = await moduleElementsObj.clickOnContactName(driver, 1);
        await contactName.click();
        await driver.sleep(2000);
...
Then('check email validation as {string} message',async function(expectedEmailValidation) {
    try {
        const updateButton = await formElementsObj.findElementById(driver, screenshotPath, 'btnSubmit');
        await updateButton.click();
        await driver.sleep(2000);
