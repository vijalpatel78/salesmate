...
Feature: Contact Module > Contact Details > Log Activity

  Description: In this feature user is able to add log to activity under contact details page
...
#------------------------ Case:2 (http://testrails.rapidops.com/index.php?/cases/view/C22475) --------------------------
  ...
  Scenario: As a User, Verify that upon clicking on save button user should be able to log any completed activity
    ...
    And verify newly added log activity details on 'icon-ic_contacts' module
