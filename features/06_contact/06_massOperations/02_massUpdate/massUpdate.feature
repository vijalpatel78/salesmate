...
Feature: Contact Module > Mass Operations > Mass Update

  Description: In this feature user is able to enable/disable mass update contact rights and manage mass update
               operations
...
#------------------------ Case:1 (http://testrails.rapidops.com/index.php?/cases/view/C21096) --------------------------
  ...
  Scenario: As a User, Verify that User can't able to see the Update options on the bulk operation when the user doesn't have a right to Mass Update Contact
    When verifying 'User2' when rights are disabled for right name of '301' through 'User1'
    Then user is on contact listing page
    Then 'Mass Update Contacts' link is not visible and log in through 'User1'

#------------------------ Case:2 (http://testrails.rapidops.com/index.php?/cases/view/C21097) --------------------------

  Scenario: As a user, I should able to see the 'Mass Update' option when user has 'Mass Update Contact' right
    When verifying 'User2' when rights are enabled for right name of '301' through 'User1'
    Then user is on contact listing page
    Then 'Mass Update Contacts' link is visible and log in through 'User1'

#------------------------ Case:3 (http://testrails.rapidops.com/index.php?/cases/view/C21098) --------------------------
  @skip_in_ci
  Scenario: As a user, I should be able to update Contacts in bulk from the mass update Contacts page
    When user is able to update Contacts in bulk from the mass update Contacts page
...
#------------------------ Case:4 (http://testrails.rapidops.com/index.php?/cases/view/C21099) --------------------------
  ...
  Scenario: As a User, Verify I should be able to display update button disable if I haven't checked any checkbox
    When user is able to display 'Update' button disable if I have not checked any checkbox under 'Mass Update Contacts' of 'icon-ic_contacts' module
...
#------------------------ Case:5 (http://testrails.rapidops.com/index.php?/cases/view/C21100) --------------------------
  ...
  Scenario: As a User, Verify upon clicking on cancel button it should terminate update process
    When user upon clicking on cancel button it should terminate update process under 'Mass Update Contacts'
...
#------------------------ Case:6 (http://testrails.rapidops.com/index.php?/cases/view/C21101) --------------------------
  ...
  Scenario: As a User, the system should give me a validation message when any criteria are not selected
    When system should give validation 'Select Search Criteria' when any criteria not selected under 'Mass Update Contacts'