...
const screenshotPath = './features/07_company/07_companyDetails/05_associatedContacts/screenshots/';
...
async function findAddAssociateButton(driver) {
    ...
    await driver.manage().setTimeouts({implicit:5000});
    try {
        addAssociateButton = await driver.findElement(By.xpath('//sm-associated-contact[@class="sm-widget-block"]//h4[@class="d-flex v-center"]/a'));
    }catch(err) {
        await driver.manage().setTimeouts({implicit:elementSearchTimeout});
...
async function findSearchField(driver) {
    ...
    await driver.manage().setTimeouts({implicit:5000});
    try {
        searchField = await driver.findElement(By.xpath('//sm-associated-contact-form//sm-autocomplete/sm-element//ro-tag/div/input'));
    }catch(err) {
        await driver.manage().setTimeouts({implicit:elementSearchTimeout});
...
async function findRemoveIcon(driver,removeIndex) {
    ...
    await driver.manage().setTimeouts({implicit:5000});
    try {
        removeIcon = await driver.findElement(By.xpath(`//div[1]/ul/li[${removeIndex}]/div[1]/div/div/a[3]/i[@class='icon-close']`));
    }catch(err) {
        await driver.manage().setTimeouts({implicit:elementSearchTimeout});
