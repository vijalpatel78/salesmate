...
const screenshotPath = './features/09_activity/05_bulkOperations/01_bulkUpdate/screenshots/';
...
Then('user is on activity listing page',async function(){
    try {
...
//----------------Case 3: As a user, I should be able to Bulk update activities from activities listing screen--------------

When('user is able to Bulk update activities from activities listing screen',async function(dataTable) {
    try {
