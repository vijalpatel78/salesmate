...
const openProductPageObj = require('../common/actions');
const performSalesmateLoginObj = require('../../../../00_common/actions/performSalesmateLogin');
const clearFieldDataObj = require('../../../../00_common/actions/fieldActions/clearFieldData');
const screenshotObj = require('../../../../00_common/actions/browserActions/takeScreenshot');
const pageNavigationObj = require('../common/actions');
const driver = require('../../../../../cucumber_config/cucumber_config').driver;
const screenshotPath = './features/03_setup/customizations/productLayout/screenshots/';
...
let searchFieldData = 'no', labelNameBeforeUpdation;
let parentFieldData = 'no', childFieldData = 'no';

Given('the {string} is on product page',async function(user) {
    const currentPageTitle = await driver.getTitle();
    const currentPageURL = await driver.getCurrentUrl();

    //will check that the user is on which page
    if(await currentPageURL.includes('app/setup/customization/layouts/6')){
         ...
         *  then the process to open product page will be started from by performing the Salesmate login
        */

        //will do Salesmate login with the specified user's credentials
        await performSalesmateLoginObj.performSalesmateLogin(driver,screenshotPath,user,'the {string} is on product page');
        //will open the product page
        await openProductPageObj.openProductPage(driver,screenshotPath);
    }
         ...
         *  then the process to open product page will be started from by opening the Salesmate login page
        */

        //will open the Salesmate login page
        await openSalesmatePageObj.openSalesmateLoginPage(driver,screenshotPath,'the {string} is on product page');
        //will do Salesmate login with the specified user's credentials
        await performSalesmateLoginObj.performSalesmateLogin(driver,screenshotPath,user,'the {string} is on product page');
        //will open the product page
        await openProductPageObj.openProductPage(driver,screenshotPath);
        ...
        //as the user is logged in, it will open the product page
        await openProductPageObj.openProductPage(driver,screenshotPath);
    }
});
...
When('the system displays a singular module product on the header',async function() {
    try {
        ...
        //get title of 'Product' Module page
        ...
        //verify whether opened 'Product' module page contains singular module name or not
        if (await currentPageHeader.includes('Product')) {
            console.log("As product module page contains " + currentPageHeader + " so,test case has been passed");
        } else {
            await assert.fail("As product page does not contains " + currentPageHeader + " so,test case has been aborted");
        }
    } catch(err) {
...
When('user adds a new section with following data in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify {string} section message in product module',async function(expectedNotificationMessage) {
    try {
        ...
        await driver.sleep(5000);
        //page navigation and come back to 'Product Layout' Page
        await pageNavigationObj.comeBackToProductPage(driver, screenshotPath);
        await driver.sleep(3000);
...
When('the user is not able to leave required fields as a blank while adding a new section in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify blank validation {string} notification in product module',async function(expectedBlankValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to enter invalid data while adding a new section in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify invalid validation message {string} in product module',async function(expectedInvalidValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to add a new section with more than 100 chars name in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify exceed length validation {string} in product module',async function(expectedLengthValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is able to update section in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify updation notification {string} in product module',async function(expectedUpdationNotification) {
    try {
        const sectionName = await driver.findElement(By.id('name')).getAttribute('value');
        const columnLayout = await commonElementsObj.findDropdown(driver, screenshotPath, 'columns');
        const columnLayoutText = await columnLayout.getText();
...
When('the user is not able to leave required fields as a blank while updating section in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is not able to enter invalid data while updating section in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is not able to update section details with more than 100 chars name in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is able to drag and drop section and verify {string} message in product module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
...
When('the user is able to expand and collapse section in product module',async function() {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
When('the user is able to add a new custom field in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify {string} notification in product module',async function(expectedFieldNotification) {
    try {
        await driver.sleep(2000);
...
When('the user is able to add a select and multi-select type custom fields in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify {string} notification message in product module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
        console.log("Custom Field Values before navigation:");
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        ...
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Multi-Select Field 01', 3, 2);
        await driver.sleep(2000);
        console.log("Custom Field Values after navigation:");
        const editPageLabelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(editPageLabelName);
...
When('the user is able to add a select type custom fields in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        ...
        await contactPageElementsObj.findNewCustomFieldButton(driver);
        await driver.sleep(3000);
        await contactPageElementsObj.selectFieldType(driver, 'Select');
        await driver.sleep(2000);
        ...
        for (let i = 0; i < dataTable.rawTable.length; i++) {
            ...
            if (fieldName == 'label name') {
                ...
                //will check that the data for the list values are given or not
                if (listValue1Data == '') {
                    await assert.fail('Due to the blank value is provided for the list value field, the test case execution has been aborted');
                }
...
Then('verify {string} field notification message in product module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
        console.log("Custom Select Field Values before navigation:");
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelName);
        const sectionName = await commonElementsObj.findDropdown(driver, screenshotPath, 'groupId');
        const sectionNameText = await sectionName.getText();
        ...
        //verify newly added 'Label Name', 'Section Name', 'List Value' and 'Required' in section
        const newlyAddedLabel = await driver.findElement(By.xpath(`//div[text()=' ${labelName} ']`));
        await driver.executeScript("arguments[0].scrollIntoView();", newlyAddedLabel);
        await driver.wait(until.elementIsVisible(newlyAddedLabel));
        const newlyAddedLabelElements = await driver.findElements(By.xpath(`//div[text()=' ${labelName} ']`));
        ...
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Select Field 01', 3, 3);
        await driver.sleep(2000);
        console.log("Custom Field Values after navigation:");
        const editPageLabelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(editPageLabelName);
        ...
        const editPageRequiredCheckbox = await driver.findElement(By.id('isRequired')).getAttribute('value');
        console.log(editPageRequiredCheckbox);
        if (labelName === editPageLabelName && sectionNameText === editPageSectionText && listValue === editPageListValue1 && requiredCheckbox === editPageRequiredCheckbox) {
            console.log("As " + labelName + " and" + sectionNameText + " and " + editPageListValue1 + "and " + requiredCheckbox + " in contact layout page are equal to " + editPageLabelName + " and" + editPageSectionText + " and" + editPageRequiredCheckbox + " in edit page,so test case has been passed");
        } else {
            await assert.fail("As " + labelName + " and" + sectionNameText + " and " + editPageListValue1 + "and " + requiredCheckbox + " in contact layout page are not equal to " + editPageLabelName + " and" + editPageSectionText + " and" + editPageRequiredCheckbox + " in edit page,so test case has been aborted");
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
When('the user is not able to leave required fields as a blank while adding a new custom field in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
        ...
        await contactPageElementsObj.findNewCustomFieldButton(driver);
        await driver.sleep(3000);
        await contactPageElementsObj.selectFieldType(driver, 'URL');
        await driver.sleep(2000);
...
When('the user is not able to add a new custom field with more than 100 chars in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
When('the user is able to search a field type while adding a new custom field in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is able to change field type while adding a new custom field in product module',async function() {
    try {
        await driver.sleep(2000);
        ...
        await driver.sleep(2000);
        await driver.manage().setTimeouts({implicit: 2000});
        const dateElements = await driver.findElements(By.xpath('//span[contains(text(), "field for Products")]'));
...
When('the new custom field details should not get changed on selecting the same type again in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        ...
        await contactPageElementsObj.findNewCustomFieldButton(driver);
        await driver.sleep(3000);
        await contactPageElementsObj.selectFieldType(driver, 'Percentage');
        await driver.sleep(2000);
        ...
        await driver.sleep(2000);
        //get values of 'Label Name', 'Section Name' and 'Required Checkbox' before changing link
        ...
        await contactPageElementsObj.selectFieldType(driver, 'Percentage');
        await driver.sleep(2000);
        //get values of 'Label', 'Section Name' and 'Required Checkbox' after changing link
        ...
        if (labelNameBeforeChangingLink === labelNameAfterChangingLink && sectionNameBeforeChangingLink === sectionNameAfterChangingLink && requiredCheckboxBeforeChangingLink === requiredCheckboxAfterChangingLink) {
            console.log("As " + labelNameBeforeChangingLink + sectionNameBeforeChangingLink + requiredCheckboxBeforeChangingLink + " are equal to " + labelNameAfterChangingLink + sectionNameAfterChangingLink + requiredCheckboxAfterChangingLink + " so,test case has been passed");
        } else {
            await assert.fail("As " + labelNameBeforeChangingLink + sectionNameBeforeChangingLink + requiredCheckboxBeforeChangingLink + " are not equal to " + labelNameAfterChangingLink + sectionNameAfterChangingLink + requiredCheckboxAfterChangingLink + " so,test case has been aborted")
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
When('the new custom field details should get changed on selecting the different type in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        ...
        await screenshotObj.takeScreenshot(driver, screenshotPath + 'unsetValuesOfPercentage.png');

        //get values of 'Label' and 'Record Label' after changing back to 'Percentage' link
        const labelNameAfterChangingLink = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelNameAfterChangingLink);

        //compare values of before and after coming back to 'Percentage'
        if (labelNameBeforeChangingLink !== labelNameAfterChangingLink) {
            console.log("As " + labelNameBeforeChangingLink + " are not equal to " + labelNameAfterChangingLink + " as values are unset after changing to different select type,so test case has been passed");
        } else {
            await assert.fail("As " + labelNameBeforeChangingLink + " are equal to " + labelNameAfterChangingLink + " as values remains as set after changing to different select type,so test case has been aborted");
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
When('the user is able to update the custom field label and required settings in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} updation message in product module',async function(expectedUpdationMsg) {
    try {
        await driver.sleep(2000);
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelName);
...
When('the user is able to change the label and related record label of custom lookup field in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} field updated notification in product module',async function(expectedUpdationNotification) {
    try {
        await driver.sleep(2000);
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelName);
        ...
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Select Field Updated 01', 2, 3);
        await driver.sleep(2000);
        //get values of 'Label Name' in 'Edit' page
        const editPageLabelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(editPageLabelName);
        if (labelName === editPageLabelName) {
            console.log("As " + labelName + " in contact layout page is equal to " + editPageLabelName + " in edit page,so test case has been passed");
        } else {
            await assert.fail("As " + labelName + " in contact layout page is not equal to " + editPageLabelName + " in edit page,so test case has been aborted");
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
When('the user is able to manage select or multi-select values in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
//-------------Case 24: Verify, the user is not able to change section name while updating a custom field---------------------------------------

When('the user is not able to change section name while updating a custom field in product module',async function() {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
//---------Case 25: Verify, the user is not able to leave required fields as a blank while updating a custom field-------------------------------------

When('the user is not able to leave label name field as a blank while updating a custom field in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
Then('verify validation {string} notification message in product module',async function(expectedLabelValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
//----------Case 26: Verify, the user is not able to update the custom field with more than 100 chars label name--------------------------------

When('the user is not able to update the custom field with more than 100 chars label name in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} validation in product module',async function(expectedLengthValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
        ...
        console.log("Label Name after updating label is: " + labelNameAfterUpdation);
        if (labelNameBeforeUpdation === labelNameAfterUpdation) {
            console.log("As label name is equal to before and after updating blank label name,so test case has been passed");
        } else {
            await assert.fail("As label name is not equal to before and after updating blank label name,so test case has been aborted");
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
//------------Case 27: Verify, the user is not able to select the same field as a parent and child while creating a map dependency----------------------------------------

When('the user is not able to select the same field as a parent and child while creating a map dependency in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} validation in product module',async function(expectedValidation) {
    try {
...
//-----------Case 28: Verify, the user is not able to create a map dependency without mapping any value--------------------------------------

When('the user is not able to create a map dependency without mapping any value in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} validation message in product module',async function(expectedValidation) {
    try {
        await contactPageElementsObj.findNextButton(driver);
...
//-----------Case 29: Verify, the user is able to create a map dependency between the select or multi-select fields---------------------------------------

When('the user is able to create a map dependency between the select or multi-select fields in product module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} message in product module',async function(expectedNotification) {
    try {
        await contactPageElementsObj.findNextButton(driver);
        await driver.sleep(2000);
        await driver.findElement(By.xpath('//div[text()="S1"]/following::option[1]')).click();
        await driver.sleep(2000);
        await contactPageElementsObj.findMapDependencySaveButton(driver);
        await driver.sleep(1000);
        const actualValidationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
...
//---------------------Case 30: Verify, the user is able to update map dependency-----------------------------------

When('the user is able to update map dependency and verify {string} in product module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
        ...
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//div[text()="S1"]/following::option[2]')).click();
        await driver.sleep(1000);
        await contactPageElementsObj.findMapDependencySaveButton(driver);
        await driver.sleep(1000);
        const actualNotificationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
...
//----------------------Case 31: Verify, the user is able to delete map dependency----------------------------------

When('the user is able to delete map dependency and verify {string} in product module',async function(expectedDeleteNotification) {
    try {
        await driver.sleep(2000);
...
//--------------------------Case 32: Verify, the user is able to drag and drop fields------------------------------------

When('the user is able to drag and drop fields and verify {string} in product module',async function(expectedNotification) {
    await driver.sleep(2000);
...
//-------------------Case 33: Verify, the user is able to deactivate fields by drag and drop-------------------------------

When('the user is able to deactivate field {string} by drag and drop and verify {string} in product module',async function(fieldName,expectedNotification) {
    await driver.sleep(2000);
    ...
    const firstInactiveFieldAfterDragAndDrop = await driver.findElement(By.xpath("//div[@id='inActiveField']/div[1]/div")).getText();
    console.log("Field Name which is at first section after drag and drop is: "+firstInactiveFieldAfterDragAndDrop);
    await driver.manage().setTimeouts({implicit: elementSearchTimeout});
});

//-------Case 34: Verify, the user is able to deactivate fields by clicking on the ‘Move to Inactive Fields’ button----------------------------

When('the user is able to deactivate {string} by clicking on the {string} button and verify {string} in product module',async function(fieldName,moveToInactiveButton,expectedNotification) {
    await driver.sleep(2000);
    ...
    await act.dragAndDrop(drag,drop).perform();
    await driver.sleep(2000);
    await driver.findElement(By.xpath('//div[contains(text()," Product")]')).click();
    await driver.sleep(3000);
    await contactPageElementsObj.customFieldDeleteButton(driver,'Custom Multi-Select Field 01',1,2);
    ...
    await pageNavigationObj.comeBackToProductPage(driver,screenshotPath);
    await driver.sleep(2000);
    //verifying display of 'Custom Multi-Select Field 01' in 'Inactive Fields' section
    ...
    //take screenshot of 'Custom Multi-Select Field 01' in 'Inactive Fields' section
    await screenshotObj.takeScreenshot(driver,screenshotPath+'customMultiSelectField01UnderInactiveFieldSection.png');
...
//--------------------Case 35: Verify, the user is able to re-activate fields------------------------

When('the user is able to re-activate {string} and verify {string} in product module',async function(fieldName,expectedNotification) {
    await driver.sleep(2000);
...
//-----------Case 36: Verify, the user is not able to deactivate required fields by drag and drop---------------------

When('the user is not able to deactivate {string} required fields by drag and drop and verify {string} in product module',async function(fieldName,expectedValidation) {
    await driver.sleep(2000);
...
//------------Case 37: Verify, the user is not able to deactivate locked fields by drag and drop-----------------------------

When('the user is not able to deactivate locked fields by drag and drop and verify {string} in product module',async function(expectedValidation) {
    await driver.sleep(2000);

    //get 'Last Name' value before dragging
    const lastNameBeforeDrag = await driver.findElement(By.xpath('//div[2]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
    const act = await driver.actions();
    const drag = await driver.findElement(By.xpath('//div[text()=" SKU/Code "]'));
    const drop = await driver.findElement(By.xpath('//div[@id="inActiveField"]'));
    await act.dragAndDrop(drag,drop).perform();
    await driver.sleep(1000);
    const actualValidationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
    ...
    const lastNameAfterDrag = await driver.findElement(By.xpath('//div[2]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
...
//-------------Case 38: Verify, the user is not able to deactivate required fields by clicking on the ‘Move to Inactive Fields’ button--------------------------------

When('the user is not able to deactivate required fields {string} by clicking on the {string} button and verify {string} in product module',async function(fieldName,moveToInactiveButton,expectedValidation) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
        //get 'Custom Field' value before dragging
        const customFieldBeforeDrag = await driver.findElement(By.xpath('//div[2]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
        ...
        await driver.sleep(5000);
        //get 'Custom Field' value before dragging
        const customFieldAfterDrag = await driver.findElement(By.xpath('//div[2]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
        if (customFieldBeforeDrag === customFieldAfterDrag) {
...
//------------Case 39: Verify, the user is not able to delete a section when section contains a required field-----------------------

When('the user is not able to delete a section {string} when section contains a required field and verify {string} in product module',async function(sectionName,expectedValidation) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
...
Then('disabling the required checkbox of custom field in product module',async function(dataTable) {
    try {
        await driver.sleep(3000);
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Field Updated 01', 3, 1);
        //will travel provided fields and data list
...
//-----------Case 40: Verify, the user is not able to delete a section when section contains a locked field----------------------

When('the user is not able to delete a section {string} when section contains a locked field and verify {string} in product module',async function(sectionName,expectedValidation) {
    try {
        await driver.sleep(2000);
...
//------------------Case 41: Verify, the user is able to delete custom fields---------------------------

When('the user is able to delete {string},{string},{string} and verify {string} message in product module',async function(customTextField,customMultiSelectField,customSelectField,expectedNotification) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
        ...
        await driver.wait(until.elementIsVisible(yesButton));
        await driver.findElement(By.xpath('//button[text()="Yes"]')).click();
        await driver.sleep(1000);
        const actualNotificationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
        await driver.wait(until.elementIsVisible(actualNotificationElement));
        ...
        await contactPageElementsObj.customFieldDeleteButton(driver, 'Custom Multi-Select Field 01', 3, 1);
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Delete It"]')).click();
        const yesOption = await driver.findElement(By.xpath('//button[text()="Yes"]'));
        await driver.wait(until.elementIsVisible(yesOption));
        await driver.findElement(By.xpath('//button[text()="Yes"]')).click();
        await driver.sleep(1000);
        ...
        await driver.sleep(2000);
        await driver.manage().setTimeouts({implicit: 2000});
        const customSelectFieldElements = await driver.findElements(By.xpath(`//div[text()=" ${customMultiSelectField} "]`));
        const customSelectFieldLength = await customSelectFieldElements.length;
        if (customSelectFieldLength === 0) {
            console.log("As " + customMultiSelectField + " is deleted it is not displayed under custom section,so test case has been passed");
        } else {
            await assert.fail("As " + customMultiSelectField + " is not deleted it is displayed under custom section,so test case has been aborted");
        }
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});

        await contactPageElementsObj.customFieldDeleteButton(driver, 'Custom Select Field Updated 01', 3, 1);
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Delete It"]')).click();
        const okButton = await driver.findElement(By.xpath('//button[text()="Yes"]'));
        await driver.wait(until.elementIsVisible(okButton));
        await driver.findElement(By.xpath('//button[text()="Yes"]')).click();
        const actualDeleteNotificationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
        await driver.wait(until.elementIsVisible(actualDeleteNotificationElement));
        const actualDeleteNotification = await driver.findElement(By.xpath('//span[@class="noty_text"]')).getText();
        ...
        await driver.sleep(2000);
        await driver.manage().setTimeouts({implicit: 2000});
        const customLookupFieldElements = await driver.findElements(By.xpath(`//div[text()=" ${customSelectField} "]`));
...
//-----------------------Case 42: Verify, the user is able to delete section---------------------------

When('the user is able to delete section {string} and verify {string} in product module',async function(sectionName,expectedNotification) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3000 }, 0);");
        await driver.sleep(2000);
