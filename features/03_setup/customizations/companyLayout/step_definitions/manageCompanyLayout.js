...
const openCompanyPageObj = require('../common/actions');
const performSalesmateLoginObj = require('../../../../00_common/actions/performSalesmateLogin');
const clearFieldDataObj = require('../../../../00_common/actions/fieldActions/clearFieldData');
const screenshotObj = require('../../../../00_common/actions/browserActions/takeScreenshot');
const pageNavigationObj = require('../common/actions');
const driver = require('../../../../../cucumber_config/cucumber_config').driver;
const screenshotPath = './features/03_setup/customizations/companyLayout/screenshots/';
...
Given('the {string} is on company page',async function(user) {
    const currentPageTitle = await driver.getTitle();
    const currentPageURL = await driver.getCurrentUrl();

    //will check that the user is on which page
    if(await currentPageURL.includes('app/setup/customization/layouts/5')){
         ...
         *  then the process to open company page will be started from by performing the Salesmate login
        */

        //will do Salesmate login with the specified user's credentials
        await performSalesmateLoginObj.performSalesmateLogin(driver,screenshotPath,user,'the {string} is on company page');
        //will open the company page
        await openCompanyPageObj.openCompanyPage(driver,screenshotPath);
    }
         ...
         *  then the process to open company page will be started from by opening the Salesmate login page
        */

        //will open the Salesmate login page
        await openSalesmatePageObj.openSalesmateLoginPage(driver,screenshotPath,'the {string} is on company page');
        //will do Salesmate login with the specified user's credentials
        await performSalesmateLoginObj.performSalesmateLogin(driver,screenshotPath,user,'the {string} is on company page');
        //will open the company page
        await openCompanyPageObj.openCompanyPage(driver,screenshotPath);
        ...
        //as the user is logged in, it will open the company page
        await openCompanyPageObj.openCompanyPage(driver,screenshotPath);
    }
});
...
When('the system displays a singular module company on the header',async function() {
    try {
        ...
        //get title of 'Company' Module page
        ...
        //verify whether opened 'Company' module page contains singular module name or not
        if (await currentPageHeader.includes('Company')) {
            console.log("As company module page contains " + currentPageHeader + " so,test case has been passed");
        } else {
            await assert.fail("As company page does not contains " + currentPageHeader + " so,test case has been aborted");
        }
    } catch(err) {
...
When('user adds a new section with following data:',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify {string} section message',async function(expectedNotificationMessage) {
    try {
        ...
        await pageNavigationObj.comeBackToCompanyPage(driver, screenshotPath);
        await driver.sleep(3000);
...
When('the user is not able to leave required fields as a blank while adding a new section in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify blank validation {string} notification in company module',async function(expectedBlankValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to enter invalid data while adding a new section in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify invalid validation message {string} in company module',async function(expectedInvalidValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to add a new section with more than 100 chars name in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify exceed length validation {string} in company module',async function(expectedLengthValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
//-------------------------------Case 5: Verify, the user is able to update section---------------------------------------------

When('the user is able to update section in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('verify updation notification {string} in company module',async function(expectedUpdationNotification) {
    try {
        const sectionName = await driver.findElement(By.id('name')).getAttribute('value');
        const columnLayout = await commonElementsObj.findDropdown(driver, screenshotPath, 'columns');
        const columnLayoutText = await columnLayout.getText();
...
When('the user is not able to leave required fields as a blank while updating section in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is not able to enter invalid data while updating section in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is not able to update section details with more than 100 chars name in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is able to drag and drop section and verify {string} message in company module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
...
When('the user is able to expand and collapse section in company module',async function() {
    try {
        await driver.sleep(2000);
        ...
        await driver.manage().setTimeouts({implicit: 2000});
        const sectionTable = await driver.findElements(By.xpath('//div[5]/table[@class="panel-body sortableSectionPanel"]'));
        ...
        await driver.manage().setTimeouts({implicit: 2000});
        const sectionTableElements = await driver.findElements(By.xpath('//div[5]/table[@class="panel-body sortableSectionPanel"]'));
...
When('the user is able to add a new custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} notification in company module',async function(expectedFieldNotification) {
    try {
        await driver.sleep(2000);
        ...
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Field 01', 5, 1);
        await driver.sleep(2000);
...
When('the user is able to add a select and multi-select type custom fields in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} notification message in company module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
        console.log("Custom Field Values before navigation:");
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        ...
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Select Field 01', 5, 2);
        await driver.sleep(2000);
        console.log("Custom Field Values after navigation:");
        const editPageLabelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(editPageLabelName);
...
When('the user is able to add a lookup type custom fields in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} field notification message in company module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
        console.log("Custom Field Values before navigation:");
        ...
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Lookup Field 01', 5, 3);
        await driver.sleep(2000);
        console.log("Custom Field Values after navigation:");
...
When('the user is not able to leave required fields as a blank while adding a new custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
//-------Case 15: Verify, the user is not able to add a new custom field with more than 100 chars label name------------------------------------

When('the user is not able to add a new custom field with more than 100 chars in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
When('the user is able to search a field type while adding a new custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is able to change field type while adding a new custom field in company module',async function() {
    try {
        await driver.sleep(2000);
        ...
        await driver.sleep(2000);
        await driver.manage().setTimeouts({implicit: 2000});
        const dateElements = await driver.findElements(By.xpath('//b//span[contains(text(), "field for Companies")]'));
        const dateElementsLength = await dateElements.length;
        if (dateElementsLength > 0) {
            console.log("As date field for companies element is found,so test case has been passed");
        } else {
            await assert.fail("As date field companies element is not found,so test case has been aborted");
        }
        await contactPageElementsObj.findCloseIcon(driver);
        await driver.sleep(2000);
    } catch(err) {
...
When('the new custom field details should not get changed on selecting the same type again in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the new custom field details should get changed on selecting the different type in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
When('the user is able to update the custom field label and required settings in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} updation message in company module',async function(expectedUpdationMsg) {
    try {
        await driver.sleep(2000);
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelName);
        ...
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Field Updated 01', 5, 1);
        await driver.sleep(2000);
        const editPageLabelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        const editPageRequiredCheckbox = await driver.findElement(By.id('isRequired')).getAttribute('value');
...
When('the user is able to change the label and related record label of custom lookup field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} field updated notification in company module',async function(expectedUpdationNotification) {
    try {
        await driver.sleep(2000);
        const labelName = await driver.findElement(By.id('displayName')).getAttribute('value');
        console.log(labelName);
        ...
        await driver.manage().setTimeouts({implicit: elementSearchTimeout});
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Lookup Field Updated 01', 5, 3);
        await driver.sleep(2000);
...
When('the user is able to manage select or multi-select values in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
When('the user is not able to change the association type of custom lookup field in company module',async function() {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
When('the user is not able to change section name while updating a custom field in company module',async function() {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
When('the user is not able to leave label name field as a blank while updating a custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify validation {string} notification message in company module',async function(expectedLabelValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to leave record label name field as a blank while updating a custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify validation {string} and {string} message in company module',async function(expectedLabelValidation,expectedRecordValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to update the custom field with more than 100 chars label name in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('verify {string} validation in company module',async function(expectedLengthValidation) {
    try {
        await contactPageElementsObj.findSaveButton(driver);
        await driver.sleep(1000);
...
When('the user is not able to select the same field as a parent and child while creating a map dependency in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} validation in company module',async function(expectedValidation) {
    try {
...
When('the user is not able to create a map dependency without mapping any value in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} validation message in company module',async function(expectedValidation) {
    try {
        await contactPageElementsObj.findNextButton(driver);
...
When('the user is able to create a map dependency between the select or multi-select fields in company module',async function(dataTable) {
    try {
        await driver.sleep(2000);
...
Then('click on next button and verify {string} message in company module',async function(expectedNotification) {
    try {
        await contactPageElementsObj.findNextButton(driver);
        await driver.sleep(2000);
...
When('the user is able to update map dependency and verify {string} in company module',async function(expectedNotification) {
    try {
        await driver.sleep(2000);
...
When('the user is able to delete map dependency and verify {string} in company module',async function(expectedDeleteNotification) {
    try {
        await driver.sleep(2000);
...
When('the user is able to drag and drop fields and verify {string} in company module',async function(expectedNotification) {
    await driver.sleep(2000);
...
When('the user is able to deactivate field {string} by drag and drop and verify {string} in company module',async function(fieldName,expectedNotification) {
    await driver.sleep(2000);
...
When('the user is able to deactivate {string} by clicking on the {string} button and verify {string} in company module',async function(fieldName,moveToInactiveButton,expectedNotification) {
    await driver.sleep(2000);
    ...
    await act.dragAndDrop(drag,drop).perform();
    await driver.sleep(2000);
    await driver.findElement(By.xpath('//div[contains(text()," Company")]')).click();
    await driver.sleep(3000);
...
When('the user is able to re-activate {string} and verify {string} in company module',async function(fieldName,expectedNotification) {
    await driver.sleep(2000);
...
When('the user is not able to deactivate {string} required fields by drag and drop and verify {string} in company module',async function(fieldName,expectedValidation) {
    await driver.sleep(2000);
...
When('the user is not able to deactivate locked fields by drag and drop and verify {string} in company module',async function(expectedValidation) {
    await driver.sleep(2000);
    ...
    const act = await driver.actions();
    const drag = await driver.findElement(By.xpath('//div[text()=" Owner "]'));
    const drop = await driver.findElement(By.xpath('//div[@id="inActiveField"]/div[1]'));
    await act.dragAndDrop(drag,drop).perform();
    await driver.sleep(1000);
    const actualValidationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
...
When('the user is not able to deactivate required fields {string} by clicking on the {string} button and verify {string} in company module',async function(fieldName,moveToInactiveButton,expectedValidation) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
        //get 'Custom Field' value before dragging
        const customFieldBeforeDrag = await driver.findElement(By.xpath('//div[5]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
        await contactPageElementsObj.customFieldDeleteButton(driver, 'Custom Field Updated 01', 5, 1);
        await driver.findElement(By.xpath(`//button[text()="${moveToInactiveButton}"]`)).click();
        await driver.sleep(1000);
        const actualValidationElement = await driver.findElement(By.xpath('//span[@class="noty_text"]'));
        await driver.wait(until.elementIsVisible(actualValidationElement));
        ...
        await driver.sleep(5000);
        //get 'Custom Field' value before dragging
        const customFieldAfterDrag = await driver.findElement(By.xpath('//div[5]/table[@class="panel-body sortableSectionPanel"]//td/div[1]')).getText();
        if (customFieldBeforeDrag === customFieldAfterDrag) {
...
When('the user is not able to delete a section {string} when section contains a required field and verify {string} in company module',async function(sectionName,expectedValidation) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
...
Then('disabling the required checkbox of custom field in company module',async function(dataTable) {
    try {
        await driver.sleep(3000);
        await contactPageElementsObj.customFieldEditButton(driver, 'Custom Field Updated 01', 5, 1);
        //will travel provided fields and data list
...
When('the user is not able to delete a section {string} when section contains a locked field and verify {string} in company module',async function(sectionName,expectedValidation) {
    try {
        await driver.sleep(2000);
...
When('the user is able to delete {string},{string},{string} and verify {string} message in company module',async function(customTextField,customSelectField,customLookupField,expectedNotification) {
    try {
        await driver.sleep(2000);
        await driver.executeScript("return $('.wrapper-lg').animate({ scrollTop: 3800 }, 0);");
        await driver.sleep(2000);
        ...
        await contactPageElementsObj.customFieldDeleteButton(driver, 'Custom Select Field 01', 5, 1);
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Delete It"]')).click();
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Yes"]')).click();
        ...
        await contactPageElementsObj.customFieldDeleteButton(driver, 'Custom Lookup Field Updated 01', 5, 1);
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Delete It"]')).click();
        await driver.sleep(1000);
        await driver.findElement(By.xpath('//button[text()="Yes"]')).click();
...
When('the user is able to delete section {string} and verify {string} in company module',async function(sectionName,expectedNotification) {
    try {
        await driver.sleep(2000);
