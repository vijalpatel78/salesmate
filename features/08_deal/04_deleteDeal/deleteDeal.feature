...
#------------------------ Case:3 (http://testrails.rapidops.com/index.php?/cases/view/C25377) --------------------------
  ...
  Scenario: As a User, Verify it should display confirmation message upon clicking on the delete deal options
    When verify it should display confirmation message upon clicking on the delete deal options
...
#------------------------ Case:4 (http://testrails.rapidops.com/index.php?/cases/view/C25378) --------------------------
  ...
  Scenario: As a user, Verify upon clicking on 'yes' button it should soft delete deal
    When verify upon clicking on "yes" button it should soft delete deal and verify 'Deal deleted successfully' message
...
#------------------------ Case:5 (http://testrails.rapidops.com/index.php?/cases/view/C25379) --------------------------
  ...
  Scenario: As a user, Verify when I click on the 'No' button it should terminate delete process
    When verify when I click on the "No" button it should terminate delete process