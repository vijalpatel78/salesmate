...
When('user is able to update Companies in bulk from the mass update Companies page',async function(dataTable) {
    try {
        ...
        const massUpdateContact = await formElementsObj.findElementByVisibleText(driver,screenshotPath,'a','Mass Update Companies')
        ...
        for (let i = 0; i < dataTable.rawTable.length; i++) {
            ...
            if (fieldName == 'select field01') {
                ...
                const addressLine2Field = await formElementsObj.findElementById(driver,screenshotPath, 'billingAddressLine2','addressLine2');
