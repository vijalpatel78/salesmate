...
Feature: Company Module > Company Detail View > Add Note

  Description: In this feature user is able to add note from company details view page and update note and can able to
...
#------------------------ Case:3 (http://testrails.rapidops.com/index.php?/cases/view/C21268) --------------------------
  ...
  Scenario: As a User, Verify that it should display success message upon clicking on the save button
    When user is on details page > add note
